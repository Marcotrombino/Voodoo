...
var Voodoo = (function (exports,window) {
  ...
  var Http = function () {
    ...
    createClass(Http, [{
      ...
      key: "xhr",
      value: function xhr(type, url, token, data) {
        var $ = this;
      ...
      key: "get",
      value: function get$$1(src, token) {
        return this.xhr("GET", src, token);
      }
    }, {
      key: "put",
      value: function put(url, token, data) {
        return this.xhr("PUT", url, token, data);
      }
    }, {
      key: "post",
      value: function post(url, token, data) {
        return this.xhr("POST", url, token, data);
      }
    }, {
      key: "delete",
      value: function _delete(url, token) {
  ...
  var VNode = function () {
    ...
    createClass(VNode, [{
      ...
      key: "inputChange",
      value: function inputChange(node, varName, eventName, newVal) {
